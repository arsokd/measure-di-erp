...
window.RevOpsStore.initSeedData = function() {
 ...
 e.role = 'super_admin';
 e.mobile = '9840629928';
 // NOTE: do NOT force e.email here. This used to hardcode it back to
 // the original measuredichennai@gmail.com seed value on every fresh
 // browser session, silently reverting Ravichandran's real corporate
 // email (ravi@measuredi.com, set later via the Employees page) back
 // to the stale address in this device's local cache — which broke
 // login-time employee matching for his real, current email.
 empListChanged = true;
