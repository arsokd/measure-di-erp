var currentTab = 'travel-app';
      ...
      function handleSaveExpense(evt) {
        ...
        var checkedProjectCbs = Array.from(document.querySelectorAll('#exp-form-projects-container input:checked'));
        var projectId = checkedProjectCbs.length > 0 ? checkedProjectCbs[0].value : '';
