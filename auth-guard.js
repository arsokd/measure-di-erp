  ...
  return `
    ...
    <header class="fixed top-0 left-0 right-0 z-50 h-14 bg-slate-900/95 backdrop-blur-md border-b border-slate-800 text-slate-200 shadow-xl px-4 flex items-center justify-between">
      ...
      <div class="flex items-center space-x-2">
        ...
        <a href="user-guide.html" class="hidden sm:flex py-1 px-2.5 text-xs font-bold text-sky-300 hover:text-white bg-sky-950/60 hover:bg-sky-900 border border-sky-800/80 rounded-lg transition-colors items-center space-x-1 cursor-pointer" title="User Guide &amp; live PDF export">
